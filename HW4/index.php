...
$profession = "Dancer";
$city = "Brazilia";
$email = "kroha@yahoo.com";
$phonenumb = "88005553535";
...
$wbackgr = [
    [
        'position' => 'Руководитель регионального направления продаж/БОТ-Лизинг',
        'periodbeg' => 'Nov 2014 - ',
        'periodend' => 'Current',
        'description' => 'Ведение проектов по финансированию оборудования и спецтехники',
    ],
    [
        'position' => 'Руководитель отраслевого направления/ИКБ-Лизинг',
        'periodbeg' => 'Jan 2008 - ',
        'periodend' => 'Nov 2014',
        'description' => 'Ведение проектов по финансированию промышленного оборудования ',
    ],
    [
        'position' => 'Руководитель отраслевого направления/Райффайзен-Лизинг',
        'periodbeg' => 'Sep 2007 - ',
        'periodend' => 'Jan 2008',
        'description' => 'Ведение проектов по финансированию оборудования и спецтехники',
    ],
                        ...
                        <?php for ($i = 0; $i < count($skills); $i++): { ?>
                                ...
                                <div class="w3-light-grey w3-round-xlarge w3-small">
                                    <div class="w3-container w3-center w3-round-xlarge w3-teal"
                                        style="width:<?= $skills[$i]['percent']; ?>%"><?= $skills[$i]['percent']; ?>%</div>
                                </div>
                            <?php }endfor; ?>
                        <br>
                    </div>
                    ...
                    <?php for ($j = 0; $j < count($wbackgr); $j++): { ?>
                            <div class="w3-container">
                                ...
                                <h6 class="w3-text-teal"><i class="fa fa-calendar fa-fw w3-margin-right"></i>
                                    <?= $wbackgr[$j]['periodbeg']; ?> -
                                    <?php if ($wbackgr[$j]['periodend'] != 'Current') { ?>
